...
$rsa=$con->query("select *from admin");
?>
          ...
          <div class="col-lg-12">
           <!-- <h4><i class="fa fa-angle-right"></i> Basic Validations</h4>-->
            <div class="form-panel">
              <form role="form" id="admin" name="admin" action="" method="post" enctype="multipart/form-data" class="form-horizontal style-form">
                ...
                <div class="form-group">
                  ...
                  <div class="col-lg-10">
                    <input type="text" placeholder="" id="password" name="t3" class="form-control" >
...
<!-----------------------------------CONNECT--HEADERPART-------------------------------->
	  ...
	  if(isset($_POST["t1"]))
	  {
		...
		$con=new PDO("mysql:dbname=tea spot","root","");
		$con->query("insert into admin(Name,Password,Emailid) values('$name','$password','$e')");
	  }
	  ?>
	  <?php
