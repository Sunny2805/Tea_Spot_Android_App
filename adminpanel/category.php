           ...
           <!-- <h4><i class="fa fa-angle-right"></i> Basic Validations</h4>-->
            <div class="form-panel">
              <form role="form" id="category" name="category" action="" method="POST" enctype="multipart/form-data" class="form-horizontal style-form">
				...
				<label for="cemail" class="control-label col-lg-2">Category Name</label>
                  <!--<label class="col-lg-2 control-label"> Category Name:</label>-->
                  <div class="col-lg-10">
                    <input type="text" placeholder="Enter The  Category Name" id="c_name" name="t1" required  class="form-control">
...
$con=new PDO("mysql:dbname=tea spot","root","");
$con->query("insert into category (Name,Photo)values('$name','$path')");
}
...
<tr>
<td><?php echo $rd["Category_id"];?></td>
<td><?php echo $rd["Name"];?></td>
<td><img src='<?php echo $rd["Photo"];?>' width="50" height="50"></td>
<!--<td><a href='#'>Delete</a></td>-->

<!--<td><a href='#'>Edit</a></td>-->
<td><a href='edit_category.php?x=<?php echo $rd["Category_id"];?>'class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></a></td>
<td><a href='delete_category.php?x=<?php echo $rd["Category_id"];?>' class="btn btn-danger btn-xs"><i class="fa fa-trash-o "></i></a></td>
