...
$rsa=$cn->query("select *from area");
  ?>		 
        ...
        <h3><i class="fa fa-angle-right"></i>Area Wise Contract Report</h3>
        ...
        <label for="cemail" class="control-label col-lg-2">Area</label>
...
<?php
 ...
 if(isset($_POST["t1"]))
{  
$rs=$cn->query("select *From contract c,area a where c.Area_id=a.Area_id and c.Area_id='".$_POST["t1"]."'");
